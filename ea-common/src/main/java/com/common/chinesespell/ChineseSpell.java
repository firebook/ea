package com.common.chinesespell;
...
public class ChineseSpell {
	...
	private static ChineseSpell chineseSpelling = new ChineseSpell();
	...
	private String getSpell(String chinese, Boolean forShort) {
		String key, value;
	...
	public String getSpell(String chinese) {
		return this.getSpell(chinese, false);
	}
	...
	public String getSpell() {
		return this.getSpell(this.getResource(), false);
	}
	 ...
	 * @return
	 */
	public String getSpellForShort(String chinese) {
		return this.getSpell(chinese, true);
	}
	 ...
	 * @return
	 */
	public Boolean compare(String chinese, String spell) {
		String pinYin = this.getSpell(chinese);
		return pinYin.indexOf(spell) > -1;
	}
	 ...
	 * @param chinese
	 *            中文
	 * @param chineseOrSpell
	 *            中文或拼音
	 * @return
	 */
	public Boolean compareByLike(String chinese, String chineseOrSpell) {
		String compareString = getSpellForShort(chinese) + chinese
				+ getSpell(chinese);
		// System.out.println(compareString);
		return compareString.indexOf(chineseOrSpell) > -1;
	}
}
