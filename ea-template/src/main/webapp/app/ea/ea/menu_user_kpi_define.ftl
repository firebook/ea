	    ...
	    <li>			  
	  	    <div class="section" style="color:green;">  
	  	      ...
	  	      <#list role.getUsers() as u>
 	  	          <a target=_blank title="个人绩效编辑" href='ea_edit_bean_property.do?objectname=User&op=r&propertyname=kpidescription&id=${u.id}'>${u.name?if_exists}</a> <br>
 	  	      </#list>		  	
		    </div>  
  		</li>
...
<p align=center><b>请点击人员名单进行绩效编辑</b></p>
	<#list rhs["roleGroupRootList"]?sort_by("sortNob") as rolegroup>
		<p align=left>${rolegroup.name}<br></p>
		<table width=2000px>
			<tr>
				<td>
