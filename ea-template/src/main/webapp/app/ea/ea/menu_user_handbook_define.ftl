		    ...
		    <li>			  
		  	    <div class="section" style="color:green;">  
		  	      ...
		  	      <#list role.getUsers() as u>
	 	  	           <a target=_blank title="工作手册编辑" href='ea_edit_bean_property.do?objectname=User&op=r&propertyname=positiondescription&id=${u.id}'>${u.name?if_exists}</a> <br>
	 	  	      </#list>		  	
			    </div>  
	  		</li>
...
<p align=center><b>请点击人员名单进行工作手册编辑</b></p>
