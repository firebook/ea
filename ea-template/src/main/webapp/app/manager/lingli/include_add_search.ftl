<form action="manager_lingli_list.do" id="searchFromId" method="post" class="form-search breadcrumb"> <#-- 该ID需当参数传入分页的宏	-->
	<a class="btn btn-primary" href="manager_lingli_load.do">添加</a>
	<span>|</span>
