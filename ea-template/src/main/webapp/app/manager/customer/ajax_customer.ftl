<div class="span10 content" id=div_customer_table>
   ...
   <table   class="table  table-condensed">
		...
		<#list rhs["dataList"]?sort_by("sortNob") as x>
			<tr>
				...
				<td>
					<select style="WIDTH: 50px"   onchange="javascript:action_customer('update.do','column=sex&id=${x.id?if_exists}&columnValue='+this.value)">
				...
				<td>
					<input type="text" value='${x.birthDate?if_exists}' onchange="javascript:action_customer('update.do','column=birthDate&id=${x.id?if_exists}&columnValue='+this.value)" onClick="WdatePicker()"/>
				</td>
				<td>
