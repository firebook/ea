...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <!-- Le styles -->
    <link href="http://www.bootcss.com/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://www.bootcss.com/assets/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="http://www.bootcss.com/assets/css/docs.css" rel="stylesheet">
    <link href="http://www.bootcss.com/assets/css/docs-cn.css" rel="stylesheet">
    <link href="http://www.bootcss.com/assets/js/google-code-prettify/prettify.css" rel="stylesheet">
...
$('[data-spy="affix"]').each(function () {
  $(this).affix('refresh')
    ...
    <footer class="footer">
      <div class="container">
        ...
        <ul class="footer-links">
          <li><a href="http://blog.getbootstrap.com" target="_blank">博客</a></li>
          <li class="muted">&middot;</li>
          <li><a href="https://github.com/twitter/bootstrap/issues?state=open" target="_blank">问题反馈</a></li>
          <li class="muted">&middot;</li>
          <li><a href="https://github.com/twitter/bootstrap/wiki" target="_blank">路线图与更新日志</a></li>
    ...
    <script src="http://www.bootcss.com/assets/js/bootstrap.min.js"></script>
    
		<script src="http://www.bootcss.com/assets/js/holder/holder.js"></script>
    <script src="http://www.bootcss.com/assets/js/google-code-prettify/prettify.js"></script>

    <script src="http://www.bootcss.com/assets/js/application.js"></script>
...
<!-- 
Parsed and Created as Static files!
-->
